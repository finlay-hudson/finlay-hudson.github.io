...
$(document).ready(function () {
    ...
    configure_carousel();
     ...
     let defaultMethodPill = document.querySelector('.traindata-method-pill[data-value="TU-BERLIN"]');
...
function selectTrainDataVideo(methodPill, scenePill, modePill) {
    ...
    // const defaultMethodPill = "TU-BERLIN";
    // const videoElement = document.getElementById("traindataVideo0");
    // const videoSource = `videos/stitched_animation_${defaultMethodPill}.mp4`;
    ...
    video_active.src = "videos/stitched_animation_" + pill + ".mp4";
    video_active.load();
    // video_active.style.width = "100%"; // Full width of container
    video_active.style.maxWidth = "6000px"; // Limit maximum width
    ...
    video_active.style.position = "absolute";
    video_active.style.top = "42%";
    video_active.style.left = "50%";
    video_active.style.transform = "translate(-50%, -50%)";
    video_active.style.width = "130%";
    video_active.style.height = "140%";

    // const defaultPill = document.querySelector(`[data-value="${defaultMethodPill}"]`);
    // if (defaultPill) {
